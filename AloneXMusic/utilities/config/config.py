...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "𝐀ℓσиє ✘ 𝐌ʋsɩƈ")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5336023580").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/TeamAloneOp/AloneXMusic/fork")
...
if PING_IMG_URL:
    if PING_IMG_URL != "AloneXMusic/resource/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://te.legra.ph/file/6abc32c3858f205434cd5.jpg"

if START_IMG_URL:
    if START_IMG_URL != "AloneXMusic/resource/Ping.jpeg":
