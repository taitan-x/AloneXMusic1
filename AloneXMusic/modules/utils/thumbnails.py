...
from AloneXMusic.resource import thumbs, colors
from AloneXMusic.utilities.config import YOUTUBE_IMG_URL
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"AloneXMusic/resource/{images}.png")
        ...
        font = ImageFont.truetype("AloneXMusic/resource/font2.ttf", 45)
        ImageFont.truetype("AloneXMusic/resource/font2.ttf", 70)
        arial = ImageFont.truetype("AloneXMusic/resource/font2.ttf", 30)
        ImageFont.truetype("AloneXMusic/resource/font.ttf", 30)
