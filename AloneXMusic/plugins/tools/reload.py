...
from AloneXMusic.utilities.config import BANNED_USERS, MUSIC_BOT_NAME, adminlist, lyrical
...
from AloneXMusic.modules.main.database import get_authuser_names, get_cmode
from AloneXMusic.modules.main.decorators import (ActualAdminCB, AdminActual,
                                         language)
from AloneXMusic.modules.utils.formatters import alpha_to_int
